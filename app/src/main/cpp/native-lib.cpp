...
//extern "C" JNIEXPORT jdoubleArray JNICALL Java_com_example_oae_MainActivity_fftnativetrim(
//        JNIEnv *env,
//        jclass,
//        jdoubleArray data,
//        jint N,
...
extern "C" JNIEXPORT jdoubleArray JNICALL Java_com_example_oae_OfflineRecorder_fftnative(
        JNIEnv *env,
        jclass,
        jdoubleArray data,
        jint N) {
...
extern "C" JNIEXPORT jobjectArray JNICALL Java_com_example_dpoae_SignalProcessing_fftcomplexoutnative(
        JNIEnv *env,
        jclass,
        jdoubleArray data,
        jint N) {
...
extern "C" JNIEXPORT jdoubleArray JNICALL Java_com_example_dpoae_SignalProcessing_ifftnative(
        JNIEnv *env,
        jclass,
        jobjectArray data) {
